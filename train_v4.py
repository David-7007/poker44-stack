"""Train poker44_stack_v4: recency-weighted recipe on the full corpus.
...
including the 2026-07-08 release. Writes models/poker44_stack_v4.joblib.
"""
...
OUT = Path("/root/poker44/models/poker44_stack_v4.joblib")
